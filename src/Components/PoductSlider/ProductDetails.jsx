const ProductDetails = () => {
  return (
    <div className="block md:hidden">
      <div className="detailing pt-[150px] relative flex h-[auto] w-[100%] md:flex-row justify-between text-[0.9375rem] box border border-none px-16 bg-[#fffef2] flex-col  ">
